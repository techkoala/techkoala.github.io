...
有人可能会困惑：欸？我平时看到的都是 `SHA-128`、`SHA-256`，`SHA-2` 又是什么？
...
{{< image src="https://cdn.jsdelivr.net/gh/techkoala/techkoala.github.io@master/images/Algorithm/SHA-2.png" caption="SHA-2 的第 t 个加密循环" >}}

下面这段**伪代码**总结了上面执行的所有步骤：

> 注 1：所有变量均为 32 位无符号整数，加法以 $ 2^32 $ 为模
> 
