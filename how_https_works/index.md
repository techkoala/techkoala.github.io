...
{{< image src="/images/Network/HTTPS/ssl_handshake_rsa.webp" caption="Source: [Keyless SSL: The Nitty Gritty Technical Details](https://blog.cloudflare.com/keyless-ssl-the-nitty-gritty-technical-details/)" >}} 
...
{{< image src="/images/Network/HTTPS/certificate.webp" caption="证书信息" >}}
...
{{< image src="/images/Network/HTTPS/Diffie-Hellman_Key_Exchange.webp" caption="By Original schema: A.J. Han Vinck, University of Duisburg-Essen SVG version: Flugaal [Public domain], via Wikimedia Commons" >}}

使用 Diffie–Hellman 算法交换 `premaster secret` 的流程

{{< image src="/images/Network/HTTPS/ssl_handshake_diffie_hellman.webp" caption="Source: [Keyless SSL: The Nitty Gritty Technical Details](https://blog.cloudflare.com/keyless-ssl-the-nitty-gritty-technical-details/)" >}}
...
{{< image src="/images/Network/HTTPS/dh-detail.webp" caption="Source: https://cipherstuff.wordpress.com/" >}}
